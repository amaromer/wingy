...
async function testExpenseWithEmployee() {
  try {
    ...
    // Get employees
    let employeesResponse = await axios.get('http://localhost:3000/api/employees', {
      headers: {
    ...
    const expenseData = {
      ...
      description: 'Test expense with employee deduction',
      invoice_number: 'TEST-001',
      is_vat: false
    };

    console.log('Creating expense with employee:', expenseData);
    ...
    console.log('Employee balance after deduction:', employeeBalance?.currentBalance);
